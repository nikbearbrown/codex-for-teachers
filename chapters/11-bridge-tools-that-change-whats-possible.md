...
<!-- → [DIAGRAM: The shift from productivity to pedagogy. Two objects on a horizontal line: grading tool (serves teacher) → interactive simulation (serves student). Label change: "saves time" → "enables possibility." The design question changes when the beneficiary changes. Editorial style. No color.] -->
