...
<!-- → [DIAGRAM: The book's arc as three build tiers on a timeline. Tier 1: class website (Act One). Tier 2: grading tool (Act Two). Tier 3: interactive simulation (Act Three). Each tier labeled with the conducting concept it introduces. Editorial style. No color.] -->
