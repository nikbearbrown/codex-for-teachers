...
<!-- → [DIAGRAM: Handoff condition gate. Build step N → [Handoff condition: specific, testable, binary] → Pass → Build step N+1. Fail path: revert to step N, respecify, rerun. Editorial style.] -->
...
<!-- → [TABLE: Strong vs. weak handoff conditions. Five examples for website context. Left: weak. Right: strong. No color.] -->
