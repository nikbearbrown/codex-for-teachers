...
<!-- → [DIAGRAM: Main build session vs. task queue. Main session: focused Code Mode, one step at a time, full supervisory attention. Task queue: background tasks captured and deferred; isolated contexts. Arrows: tasks fire off; returns evaluated and integrated. Editorial style.] -->
